...
/*
 * List_destroy -- Frees all the ListNodes from a List (DOES NOT free
 *                 the ListNode's values).
 */
...
/*
 * List_clear_destroy -- Frees all the given List's ListNode's values
 *                       and all the ListNodes themselves. Complete 
...
/*
 * List_debug -- Identical to List_print, but prints to stderr.
 */
